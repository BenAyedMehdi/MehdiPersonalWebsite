  ...
  return (
    <>
      <div className="flex flex-col items-center gap-[10px] justify-center md:px-10 sm:px-5 px-[120px] w-full">
        ...
        <Text
          className="leading-[180.00%] pl-4  text-center text-gray-700 text-2xl"
          size="txtManropeRegular18Gray700"
        >
          I am a big believer in the power of learning by doing. Here are some of the projects I have worked on.  
        </Text>
